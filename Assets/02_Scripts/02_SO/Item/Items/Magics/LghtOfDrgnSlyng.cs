...
namespace MinD.Magics {
	...
	public class LghtOfDrgnSlyng : Magic {
		...
		private Object.Magics.LghtOfDrgnSlyngMainObj magic;
		...
		public override void OnUse() {
			...
			magic = ObjectDataBase.Instance.InstantiateMagic("LghtOfDrgnSlyng_MainObj").GetComponent<Object.Magics.LghtOfDrgnSlyngMainObj>();
